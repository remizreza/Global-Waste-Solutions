...
import rcLogo from "@assets/royal-commission.png";
    ...
    <section className="py-10 bg-black border-y border-white/10">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24">
          ...
          <img 
            src={rcLogo} 
            alt="Royal Commission of Yanbu and Jubail" 
            className="h-12 md:h-16 w-auto opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300" 
          />
        </div>
      </div>
    </section>
